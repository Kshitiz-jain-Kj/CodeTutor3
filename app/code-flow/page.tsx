          ...
          <Card className="ring-2 ring-pop">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <select className="px-3 py-1 rounded text-sm bg-accent border border-pop text-foreground">
            ...
            <CardContent className="bg-accent p-6">
              <svg viewBox="0 0 600 500" className="w-full h-auto">
                ...
                {/* Process - loop */}
                <rect x="230" y="270" width="140" height="50" rx="5" fill="#3b82f6" stroke="#1e40af" strokeWidth="2" />
                ...
                {/* Process - find max */}
                <rect x="230" y="360" width="140" height="50" rx="5" fill="#3b82f6" stroke="#1e40af" strokeWidth="2" />
